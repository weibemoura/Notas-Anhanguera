...
public class KeyEventCompat {
    ...
    static class BaseKeyEventVersionImpl implements KeyEventVersionImpl {
        ...
        public boolean metaStateHasModifiers(int metaState, int modifiers) {
            if (metaStateFilterDirectionalModifiers(metaStateFilterDirectionalModifiers(normalizeMetaState(metaState) & META_MODIFIER_MASK, modifiers, 1, 64, AccessibilityEventCompat.TYPE_VIEW_HOVER_ENTER), modifiers, 2, 16, 32) == modifiers) {
                return true;
            }
            return false;
        }
