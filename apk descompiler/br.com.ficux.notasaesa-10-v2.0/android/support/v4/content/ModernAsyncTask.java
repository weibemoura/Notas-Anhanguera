...
abstract class ModernAsyncTask<Params, Progress, Result> {
    ...
    static class C00051 implements ThreadFactory {
    ...
    class C00062 extends WorkerRunnable<Params, Result> {
        C00062() {
            super();
        }
    ...
    class C00073 extends FutureTask<Result> {
        C00073(Callable x0) {
            super(x0);
        }
    ...
    public ModernAsyncTask() {
        ...
        this.mWorker = new C00062();
        this.mFuture = new C00073(this.mWorker);
    }
    ...
    public final ModernAsyncTask<Params, Progress, Result> executeOnExecutor(Executor exec, Params... params) {
        if (this.mStatus != Status.PENDING) {
            switch (C00084.$SwitchMap$android$support$v4$content$ModernAsyncTask$Status[this.mStatus.ordinal()]) {
