...
public class FragmentActivity extends Activity {
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (index != 0) {
            ...
            frag.onActivityResult(Menu.USER_MASK & requestCode, resultCode, data);
            return;
        }
    ...
    public boolean onMenuItemSelected(int featureId, MenuItem item) {
        ...
        switch (featureId) {
            ...
            case C0029R.styleable.SherlockTheme_actionBarSplitStyle /*6*/:
    ...
    public void startActivityForResult(Intent intent, int requestCode) {
        if (requestCode == -1 || (Menu.CATEGORY_MASK & requestCode) == 0) {
    ...
    public void startActivityFromFragment(Fragment fragment, Intent intent, int requestCode) {
        ...
        } else if ((Menu.CATEGORY_MASK & requestCode) != 0) {
            throw new IllegalArgumentException("Can only use lower 16 bits for requestCode");
        } else {
            super.startActivityForResult(intent, ((fragment.mIndex + MSG_REALLY_STOPPED) << 16) + (Menu.USER_MASK & requestCode));
        }
    }
