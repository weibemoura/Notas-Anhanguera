...
class ActivityChooserView extends ViewGroup implements ActivityChooserModelClient {
    ...
    class C00541 extends DataSetObserver {
        C00541() {
        }
    ...
    class C00552 implements OnGlobalLayoutListener {
        C00552() {
        }
    ...
    class C00563 extends DataSetObserver {
        C00563() {
        }
    ...
    private class ActivityChooserViewAdapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            switch (getItemViewType(position)) {
                case ITEM_VIEW_TYPE_ACTIVITY /*0*/:
                    if (convertView == null || convertView.getId() != C0029R.id.abs__list_item) {
                        convertView = LayoutInflater.from(ActivityChooserView.this.getContext()).inflate(C0029R.layout.abs__activity_chooser_view_list_item, parent, false);
                    }
                    PackageManager packageManager = ActivityChooserView.this.mContext.getPackageManager();
                    ResolveInfo activity = (ResolveInfo) getItem(position);
                    ((ImageView) convertView.findViewById(C0029R.id.abs__icon)).setImageDrawable(activity.loadIcon(packageManager));
                    ((TextView) convertView.findViewById(C0029R.id.abs__title)).setText(activity.loadLabel(packageManager));
                ...
                case ITEM_VIEW_TYPE_FOOTER /*1*/:
                    if (convertView == null || convertView.getId() != ITEM_VIEW_TYPE_FOOTER) {
                        ...
                        ((TextView) convertView.findViewById(C0029R.id.abs__title)).setText(ActivityChooserView.this.mContext.getString(C0029R.string.abs__activity_chooser_view_see_all));
                    }
                    return convertView;
                default:
                    throw new IllegalArgumentException();
    ...
    private class Callbacks implements OnItemClickListener, OnClickListener, OnLongClickListener, OnDismissListener {
        ...
        public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
            switch (((ActivityChooserViewAdapter) parent.getAdapter()).getItemViewType(position)) {
                case IcsListPopupWindow.POSITION_PROMPT_ABOVE /*0*/:
    ...
    public ActivityChooserView(Context context, AttributeSet attrs, int defStyle) {
        ...
        this.mModelDataSetOberver = new C00541();
        this.mOnGlobalLayoutListener = new C00552();
        this.mInitialActivityCount = 4;
        this.mContext = context;
        TypedArray attributesArray = context.obtainStyledAttributes(attrs, C0029R.styleable.SherlockActivityChooserView, defStyle, 0);
        ...
        LayoutInflater.from(this.mContext).inflate(C0029R.layout.abs__activity_chooser_view, this, true);
        this.mCallbacks = new Callbacks();
        this.mActivityChooserContent = (IcsLinearLayout) findViewById(C0029R.id.abs__activity_chooser_view_content);
        this.mActivityChooserContentBackground = this.mActivityChooserContent.getBackground();
        this.mDefaultActivityButton = (FrameLayout) findViewById(C0029R.id.abs__default_activity_button);
        this.mDefaultActivityButton.setOnClickListener(this.mCallbacks);
        this.mDefaultActivityButton.setOnLongClickListener(this.mCallbacks);
        this.mDefaultActivityButtonImage = (ImageView) this.mDefaultActivityButton.findViewById(C0029R.id.abs__image);
        this.mExpandActivityOverflowButton = (FrameLayout) findViewById(C0029R.id.abs__expand_activities_button);
        this.mExpandActivityOverflowButton.setOnClickListener(this.mCallbacks);
        this.mExpandActivityOverflowButtonImage = (ImageView) this.mExpandActivityOverflowButton.findViewById(C0029R.id.abs__image);
        ...
        this.mAdapter.registerDataSetObserver(new C00563());
        Resources resources = context.getResources();
        this.mListPopupMaxWidth = Math.max(resources.getDisplayMetrics().widthPixels / 2, resources.getDimensionPixelSize(C0029R.dimen.abs__config_prefDialogWidth));
    }
    ...
    private void showPopupUnchecked(int maxActivityCount) {
        ...
        if (!popupWindow.isShowing()) {
            ...
            popupWindow.getListView().setContentDescription(this.mContext.getString(C0029R.string.abs__activitychooserview_choose_application));
        }
    }
