...
public final class ResourcesCompat {
    ...
    public static boolean getResources_getBoolean(Context context, int id) {
        ...
        if (id == C0029R.bool.abs__action_bar_embed_tabs) {
            if (widthDp < 480.0f) {
                return false;
            }
            return true;
        } else if (id == C0029R.bool.abs__split_action_bar_is_narrow) {
            if (widthDp >= 480.0f) {
                return false;
            }
            return true;
        } else if (id == C0029R.bool.abs__action_bar_expanded_action_views_exclusive) {
            if (smallestWidthDp >= 600.0f) {
                return false;
            }
            return true;
        } else if (id != C0029R.bool.abs__config_allowActionMenuItemTextWithIcon) {
    ...
    public static int getResources_getInteger(Context context, int id) {
        ...
        DisplayMetrics metrics = context.getResources().getDisplayMetrics();
        float widthDp = ((float) metrics.widthPixels) / metrics.density;
        if (id != C0029R.integer.abs__max_action_buttons) {
