...
public class ActionBarSherlockCompat extends ActionBarSherlock implements Callback, Window.Callback, MenuPresenter.Callback, OnMenuItemClickListener {
    ...
    public ActionMode startActionMode(ActionMode.Callback callback) {
        ...
        if (mode != null) {
            ...
            if (this.mActionModeView == null) {
                ViewStub stub = (ViewStub) this.mDecor.findViewById(C0029R.id.abs__action_mode_bar_stub);
                if (stub != null) {
    ...
    private boolean initializePanelMenu() {
        ...
        if (this.wActionBar != null) {
            ...
            context.getTheme().resolveAttribute(C0029R.attr.actionBarWidgetTheme, outValue, true);
    ...
    private IcsProgressBar getCircularProgressBar(boolean shouldInstallDecor) {
        ...
        this.mCircularProgressBar = (IcsProgressBar) this.mDecor.findViewById(C0029R.id.abs__progress_circular);
        if (this.mCircularProgressBar != null) {
    ...
    private IcsProgressBar getHorizontalProgressBar(boolean shouldInstallDecor) {
        ...
        this.mHorizontalProgressBar = (IcsProgressBar) this.mDecor.findViewById(C0029R.id.abs__progress_horizontal);
        if (this.mHorizontalProgressBar != null) {
    ...
    public boolean requestFeature(int featureId) {
        ...
        switch (featureId) {
            ...
            case com.actionbarsherlock.view.MenuItem.SHOW_AS_ACTION_COLLAPSE_ACTION_VIEW /*8*/:
            case C0029R.styleable.SherlockTheme_actionBarDivider /*9*/:
            case C0029R.styleable.SherlockTheme_actionBarItemBackground /*10*/:
    ...
    private void installDecor() {
        ...
        if (this.mContentParent == null) {
            ...
            if (this.mTitleView == null) {
                this.wActionBar = (ActionBarView) this.mDecor.findViewById(C0029R.id.abs__action_bar);
                if (this.wActionBar != null) {
                    ...
                    if (splitWhenNarrow) {
                        splitActionBar = ResourcesCompat.getResources_getBoolean(this.mActivity, C0029R.bool.abs__split_action_bar_is_narrow);
                    } else {
                        splitActionBar = this.mActivity.getTheme().obtainStyledAttributes(C0029R.styleable.SherlockTheme).getBoolean(48, false);
                    }
                    ActionBarContainer splitView = (ActionBarContainer) this.mDecor.findViewById(C0029R.id.abs__split_action_bar);
                    if (splitView != null) {
                        ...
                        this.mActionModeView = (ActionBarContextView) this.mDecor.findViewById(C0029R.id.abs__action_context_bar);
    ...
    private ViewGroup generateLayout() {
        TypedArray a = this.mActivity.getTheme().obtainStyledAttributes(C0029R.styleable.SherlockTheme);
        ...
        if (a.hasValue(45)) {
            ...
            if (hasFeature(1)) {
                if (!hasFeature(10) || hasFeature(1)) {
                    layoutResource = C0029R.layout.abs__screen_simple;
                } else {
                    layoutResource = C0029R.layout.abs__screen_simple_overlay_action_mode;
                }
            } else if (this.mIsFloating) {
                this.mDecor = (ViewGroup) this.mDecor.getParent();
                this.mDecor.removeAllViews();
                layoutResource = C0029R.layout.abs__dialog_title_holo;
            } else if (hasFeature(9)) {
                layoutResource = C0029R.layout.abs__screen_action_bar_overlay;
            } else {
                layoutResource = C0029R.layout.abs__screen_action_bar;
            }
            this.mDecor.addView(this.mActivity.getLayoutInflater().inflate(layoutResource, null), new LayoutParams(-1, -1));
            ViewGroup contentParent = (ViewGroup) this.mDecor.findViewById(C0029R.id.abs__content);
