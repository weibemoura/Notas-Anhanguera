...
public class ActionMenuItemView extends LinearLayout implements ItemView, OnClickListener, OnLongClickListener, ActionMenuChildView, View_HasStateListenerSupport {
    ...
    public ActionMenuItemView(Context context, AttributeSet attrs, int defStyle) {
        ...
        this.mAllowTextWithIcon = ResourcesCompat.getResources_getBoolean(context, C0029R.bool.abs__config_allowActionMenuItemTextWithIcon);
        TypedArray a = context.obtainStyledAttributes(attrs, C0029R.styleable.SherlockActionMenuItemView, 0, 0);
    ...
    public void onFinishInflate() {
        this.mImageButton = (ImageButton) findViewById(C0029R.id.abs__imageButton);
        this.mTextButton = (CapitalizingButton) findViewById(C0029R.id.abs__textButton);
