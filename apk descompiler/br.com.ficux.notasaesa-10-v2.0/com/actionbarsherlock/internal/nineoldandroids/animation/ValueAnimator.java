...
public class ValueAnimator extends Animator {
    ...
    class C00341 extends ThreadLocal<ArrayList<ValueAnimator>> {
        C00341() {
        }
    ...
    class C00352 extends ThreadLocal<ArrayList<ValueAnimator>> {
        C00352() {
        }
    ...
    class C00363 extends ThreadLocal<ArrayList<ValueAnimator>> {
        C00363() {
        }
    ...
    class C00374 extends ThreadLocal<ArrayList<ValueAnimator>> {
        C00374() {
        }
    ...
    class C00385 extends ThreadLocal<ArrayList<ValueAnimator>> {
        C00385() {
        }
    ...
    static {
        ...
        sAnimations = new C00341();
        sPendingAnimations = new C00352();
        sDelayedAnims = new C00363();
        sEndingAnims = new C00374();
        sReadyAnims = new C00385();
    ...
    public void setIntValues(int... values) {
        if (values != null && values.length != 0) {
            if (this.mValues == null || this.mValues.length == 0) {
                ...
                propertyValuesHolderArr[ANIMATION_START] = PropertyValuesHolder.ofInt("", values);
    ...
    public void setFloatValues(float... values) {
        if (values != null && values.length != 0) {
            if (this.mValues == null || this.mValues.length == 0) {
                PropertyValuesHolder[] propertyValuesHolderArr = new PropertyValuesHolder[RUNNING];
                propertyValuesHolderArr[ANIMATION_START] = PropertyValuesHolder.ofFloat("", values);
                setValues(propertyValuesHolderArr);
            } else {
    ...
    public void setObjectValues(Object... values) {
        if (values != null && values.length != 0) {
            if (this.mValues == null || this.mValues.length == 0) {
                PropertyValuesHolder[] propertyValuesHolderArr = new PropertyValuesHolder[RUNNING];
                propertyValuesHolderArr[ANIMATION_START] = PropertyValuesHolder.ofObject("", null, values);
                setValues(propertyValuesHolderArr);
            } else {
    ...
    public ValueAnimator clone() {
        ...
        if (this.mUpdateListeners != null) {
            ...
            for (i = ANIMATION_START; i < numListeners; i += RUNNING) {
                anim.mUpdateListeners.add((AnimatorUpdateListener) oldListeners.get(i));
            }
        }
        anim.mSeekTime = -1;
