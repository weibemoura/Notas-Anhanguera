...
public final class AnimatorSet extends Animator {
    ...
    public ArrayList<Animator> getChildAnimations() {
        ...
        while (it.hasNext()) {
            childList.add(((Node) it.next()).animation);
        }
        return childList;
    }
    ...
    public void setTarget(Object target) {
        Iterator it = this.mNodes.iterator();
        while (it.hasNext()) {
            Animator animation = ((Node) it.next()).animation;
    ...
    public AnimatorSet setDuration(long duration) {
        ...
        Iterator it = this.mNodes.iterator();
        while (it.hasNext()) {
            ((Node) it.next()).animation.setDuration(duration);
        }
    ...
    public void start() {
        ...
        for (i = 0; i < numSortedNodes; i++) {
            ...
            if (oldListeners != null && oldListeners.size() > 0) {
                it = new ArrayList(oldListeners).iterator();
                while (it.hasNext()) {
                    AnimatorListener listener = (AnimatorListener) it.next();
        ...
        if (this.mStartDelay <= 0) {
            ...
            this.mDelayAnim.addListener(new C00331(nodesToStart));
    ...
    public AnimatorSet clone() {
        ...
        while (it.hasNext()) {
            ...
            if (cloneListeners != null) {
                ...
                it2 = cloneListeners.iterator();
                while (it2.hasNext()) {
                    AnimatorListener listener = (AnimatorListener) it2.next();
                ...
                if (listenersToRemove != null) {
                    it2 = listenersToRemove.iterator();
                    while (it2.hasNext()) {
                        cloneListeners.remove((AnimatorListener) it2.next());
                    }
                }
            }
        }
